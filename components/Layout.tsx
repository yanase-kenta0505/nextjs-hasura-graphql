          ...
          <div className='flex items-center pl-8 h-14'>
            <div className='flex space-x-4'>
              ...
              <Link href='/local-state-a'>
                <a data-testid='makevar-nav' className='text-gray-300 hover:bg-gray-700 px-3 py-2 rounded'>
                  makeVar
                </a>
              </Link>
              <Link href='/hasura-main'>
                <a data-testid='fetchpolicy-nav' className='text-gray-300 hover:bg-gray-700 px-3 py-2 rounded'>
                  fetchpolicy(hasura)
                </a>
              </Link>
